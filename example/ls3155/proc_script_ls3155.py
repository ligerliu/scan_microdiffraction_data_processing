...
proposal_path = "/data/visitor/ls3155/id13/20230217/"
proposal_num  = "ls3155"
...
save_path = '/data/visitor/ls3155/id13/XXPROCESS/integration'

poni = '/data/visitor/ls3155/id13/XXPROCESS/poni_ls3155.poni'
msk_file = '/data/visitor/ls3155/id13/XXPROCESS/mask_ls3155.edf'
...
auto_proc_qphi(t1,samples,save_path,num_core=24,q_npts=720, a_npts=360,poni=poni,mask=mask,)#radial_range=(0,0.2))
