...
class NewSample(QWidget):
    ...
    def setupUI(self):
        ...
        self.file_tree = ft.tree()
        newfile_button = QPushButton("load data",self)
        new_func1      = QPushButton("func1",self)
        new_func2      = QPushButton("func2",self)
        new_func3      = QPushButton("func3",self)
        #mainLayout = QVBoxLayout()
        mainLayout = QGridLayout()
        mainLayout.setColumnStretch(1,4)
        mainLayout.setColumnStretch(2,4)
        mainLayout.addWidget(newfile_button,1,1)
        mainLayout.addWidget(new_func1,2,1)
        mainLayout.addWidget(new_func2,3,1)
        mainLayout.addWidget(new_func3,4,1)
        try:
    ...
    def openFileNameDialog(self):
        ...
        filename, _ = QFileDialog.getOpenFileName(self,
                        "HDF Files (*.h5)", options = options)
        self.file_tree.add_file(filename)
        self.file_tree.show()
        
        p = self.file_tree.h5_file_path.split('/id13/')[0]
